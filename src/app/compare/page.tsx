    ...
    <div className="min-h-screen bg-[#08090d] text-white font-sans">
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          {items.map((skin) => {
            ...
            return (
              <div
                key={skin.id}
                className="bg-[#11141d] p-8 rounded-[3rem] border border-white/5 shadow-2xl relative overflow-hidden"
              >
                <div
                ...
                <div className="relative z-10 space-y-6">
                  ...
                  <div className="flex flex-wrap gap-2 text-[9px] uppercase">
                    ...
                    {skin.collections?.[0]?.name && (
                      <span className="px-3 py-1 rounded-full bg-black/40 border border-white/10 text-gray-400">
                        {skin.collections[0].name}
                      </span>
                    )}
                    {skin.team?.name && (
        ...
        <section className="space-y-4">
          <div className="grid grid-cols-3 px-4 md:px-10 mb-4">
            <div className="text-[10px] font-black uppercase tracking-widest text-blue-500 truncate">
              {items[0].weapon?.name || items[0].name}
            </div>
            <div className="text-center text-[10px] font-black uppercase tracking-widest text-gray-600">
              Metric
            </div>
            <div className="text-right text-[10px] font-black uppercase tracking-widest text-purple-500 truncate">
              {items[1].weapon?.name || items[1].name}
            </div>
          </div>
