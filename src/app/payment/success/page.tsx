...
function PaymentSuccessContent() {
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-[#08090d] text-white flex items-center justify-center font-sans px-6">
        <div className="w-full max-w-lg bg-[#11141d] border border-red-500/30 p-10 rounded-[3rem] shadow-2xl text-center space-y-6">
  ...
  return (
    <div className="min-h-screen bg-[#08090d] text-white flex items-center justify-center font-sans px-6">
      <div className="w-full max-w-lg bg-[#11141d] border border-emerald-500/30 p-10 rounded-[3rem] shadow-2xl text-center space-y-6">
        <div className="flex justify-center">
          <div className="p-4 rounded-full bg-emerald-500/10 border border-emerald-500/40">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/inventory"
            className="bg-blue-600 px-6 py-3 rounded-2xl font-black uppercase text-xs tracking-widest hover:bg-blue-500 transition-all"
          >
            Go to My Vault
          </Link>
          <Link
            href="/pro"
            className="bg-black/40 border border-white/10 px-6 py-3 rounded-2xl font-black uppercase text-xs tracking-widest hover:border-white/20 transition-all"
          >
            View Pro Info
          </Link>
        </div>
