          ...
          <div className="bg-[#11141d] border border-white/10 rounded-[2rem] md:rounded-[3rem] p-6 md:p-10 shadow-2xl space-y-6 md:space-y-8 text-[11px] md:text-[12px] leading-relaxed">
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-300 ml-4">
                ...
                <li><strong>New User Bonus:</strong> Some new users may be eligible for a one-time 2-week Pro access bonus within 7 days of first sign-in. This bonus must be activated manually and expires after 7 days if not used.</li>
