...
export default function ChristmasPromo({ steamId, onDismiss, onClaim }: ChristmasPromoProps) {
  ...
  useEffect(() => {
    // Start animation: Santa comes, throws gift (miss 2x, hit 3rd time)
  ...
  if (!giftOpened) {
    return (
      <div className="fixed inset-0 z-[10000] pointer-events-none">
        ...
        {/* Santa with sleigh - coming from top right */}
        ...
        {/* Gift flying/bouncing - misses first 2 times, lands 3rd time */}
        {giftThrown && throwAttempt <= 3 && (
          <div 
  ...
  return (
    <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="relative bg-gradient-to-br from-red-600/90 to-green-600/90 border-4 border-white/30 rounded-3xl p-8 md:p-12 max-w-lg w-full shadow-2xl animate-scale-in">
        <button
          onClick={onDismiss}
